...
{
    public partial class RolesAccesos_Consulta : Form
    {
        public RolesAccesos_Consulta()
        {
            InitializeComponent();
        }
        ...
        {
            iTechERP.Seguridad.RolesAccesos roles = new Seguridad.RolesAccesos();
            this.Close();
            roles.Show();
        }
