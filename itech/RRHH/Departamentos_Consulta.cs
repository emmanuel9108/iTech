...
{
    public partial class Departamentos_Consulta : Form
    {
        ...
        {
            Departamentos pantallaRRHH = new Departamentos();
            this.Close();
            pantallaRRHH.Show();
        }
        ...
        {
            if (richTextBox1.Text == "Departamento")
            {
                richTextBox1.Text = "";
        ...
        private void richTextBox1_MouseLeave(object sender, EventArgs e)
        {
            ...
            {
                richTextBox1.Text = "Departamento";
